...
public class VariantiModalViewModel {
    ...
    public void onCreateVariant(@BindingParam("type") String type) {
        ...
        VariantContextMenuModalViewModel.apriPopup(params).addEventListener(Events.ON_CLOSE, new VariantsModalCloseListener(this));
    }
