...
public class Articoli {
    ...
    Long id;
    @Column(name = "idcategoria", columnDefinition = "INT(11) NULL DEFAULT NULL")
    Long idCategoria;
    @Column(name = "idmarca", columnDefinition = "INT(11) NULL DEFAULT NULL")
    Long idMarca;
    @Column(name = "idanagrafica", columnDefinition = "INT(11) NULL DEFAULT NULL")
    Long idAnagrafica;
